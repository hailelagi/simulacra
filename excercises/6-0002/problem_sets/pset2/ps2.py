...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.clean = room.cleanTileAtPosition(self.getRobotPosition())
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        while True:
            new = self.getRobotPosition().getNewPosition(self.setRobotDirection(random.randint(0, 360)), self.speed)
            if self.room.isPositionInRoom(new):
                self.setRobotPosition(new)
                break
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    return (sum(time_steps)/len(time_steps)) / num_robots
...
#
#       (... your call here ...)
#showPlot1("show plot one", "x-axis", "y-axis")
...
#
#       (... your call here ...)
#showPlot2("show plot two", "x-axis", "y-axis")
